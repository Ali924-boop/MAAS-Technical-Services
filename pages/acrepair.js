...
const Acrepair = () => {
  ...
  useEffect(() => {
    if (router.pathname === "/acrepair") {
      setService("AC Repair"); // Set default service for AC Repair page
    }
  ...
  const services = [
    ...
    "Painting",
    "Wallpaper Fixing",
    "AC Repair", // Adding AC Repair to the list of services
  ];
      ...
      <div className="container px-5 py-24 mx-auto flex flex-col lg:flex-row gap-10">
        ...
        >
          ...
          <h1 className="text-gray-900 text-3xl title-font font-medium mb-4">
            Get The Best AC Repair Services In Dubai
          </h1>
          <p className="leading-relaxed mb-6">
            Our expert technicians provide top-notch AC repair services in Dubai, ensuring your systems run smoothly and efficiently.
          </p>

...
const Acmaintenance = () => {
  ...
  useEffect(() => {
    if (router.pathname === "/acmaintenance") {
      setService("AC Maintenance"); // Set default service for AC Maintenance page
    }
      ...
      <div className="container px-5 py-24 mx-auto flex flex-col lg:flex-row gap-10">
        ...
        >
          ...
          <h1 className="text-gray-900 text-3xl title-font font-medium mb-4">
            Get The Best AC Maintenance Services In Dubai
          </h1>
          <p className="leading-relaxed mb-6">
            Refresh your interiors and exteriors with Maas Technical’s AC Maintenance services. Our skilled technicians ensure the best quality service tailored to your needs.
          </p>

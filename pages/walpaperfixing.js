...
const Walpaperfixing = () => {
  ...
  useEffect(() => {
    if (router.pathname === "/walpaperfixing") {
      setService("Wallpaper Fixing"); // Set default service for Wallpaper Fixing page
    }
  ...
  const services = [
    ...
    "Sofa Cleaning",
    "Painting",
    "Wallpaper Fixing", // Wallpaper Fixing is active for this page
  ];

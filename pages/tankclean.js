...
const Tankclean = () => {
  ...
  useEffect(() => {
    if (router.pathname === "/tankclean") {
      setService("Water Tank Cleaning"); // Set default service for Tank Clean page
    }
  ...
  const services = [
    "AC Installation",
    "Carpet Cleaning",
    "Water Tank Cleaning", // Adding Water Tank Cleaning to the list of services
    "AC Maintenance",
    "AC Duct Cleaning",
    "Electrical",
    "Plumbing",
      ...
      <div className="container px-5 py-24 mx-auto flex flex-col lg:flex-row gap-10">
        ...
        >
          ...
          <h1 className="text-gray-900 text-3xl title-font font-medium mb-4">
            Get The Best Water Tank Cleaning Services In Dubai
          </h1>
          <p className="leading-relaxed mb-6">
            Our water tank cleaning service ensures the highest standards of hygiene and safety for your home or business. Over time, sediment, rust, and biological contaminants can accumulate, compromising water quality and risking health. Our trained technicians use industry-approved methods, including draining, scrubbing, disinfection, and thorough rinsing with food-grade sanitizers. We inspect all fittings, filters, and inlet/outlet pipes, repairing or replacing worn components as needed. After cleaning, we perform water testing to confirm purity and compliance with health guidelines. Regular maintenance with Maas Technical extends the life of your tank, prevents unpleasant odors and taste issues, and guarantees fresh, crystal-clear water every time.
          </p>

...
const Plumbing = () => {
  ...
  useEffect(() => {
    if (router.pathname === "/plumbing") {
      setService("Plumbing"); // Set default service for Plumbing page
    }
  ...
  const services = [
    ...
    "AC Duct Cleaning",
    "Electrical",
    "Plumbing", // Adding Plumbing to the list of services
    "Sofa Cleaning",
    "Painting",
    "Wallpaper Fixing",
  ];
      ...
      <div className="container px-5 py-24 mx-auto flex flex-col lg:flex-row gap-10">
        ...
        >
          ...
          <h1 className="text-gray-900 text-3xl title-font font-medium mb-4">
            Get The Best Plumbing Services In Dubai
          </h1>
          <p className="leading-relaxed mb-6">
            Our expert plumbing services in Dubai cover everything from leak repairs and pipe installations to clogged drains and water heater fixes. We ensure fast, reliable, and hygienic solutions using quality materials and skilled technicians. Trust MAAS Technical Cleaning for affordable, professional plumbing tailored to your home or business needs.
          </p>

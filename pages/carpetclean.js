...
const Carpetclean = () => {
  ...
  useEffect(() => {
    if (router.pathname === "/carpetclean") {
      setService("Carpet Cleaning"); // Set default service for Carpet Cleaning page
    }
  ...
  const services = [
    "AC Installation",
    "Carpet Cleaning",  // Carpet Cleaning is active for this page
    "Water Tank Cleaning",
    "AC Maintenance",
    "AC Duct Cleaning",
    "Electrical",
      ...
      <div className="container px-5 py-24 mx-auto flex flex-col lg:flex-row gap-10">
        ...
        >
          ...
          <h1 className="text-gray-900 text-3xl title-font font-medium mb-4">
            Get The Best Carpet Cleaning Services In Dubai
          </h1>
          <p className="leading-relaxed mb-6">
            Transform your floors with our comprehensive carpet cleaning service. Carpets endure heavy foot traffic, trapping dust, pet dander, spills, and bacteria that degrade indoor air and fabric integrity. We start with a thorough vacuuming and spot-treatment of oils, dyes, and high-traffic areas using biodegradable cleaning agents. Next, our hot water extraction process penetrates deep into fibers, emulsifying and removing embedded soil while preserving pile structure. We finish by applying a protective finish to repel future dirt and accelerate drying. With Maas Technical’s carpet cleaning, you’ll enjoy brighter colors, softer textures, and a healthier, allergen-reduced environment—ideal for families, pets, and businesses alike.
          </p>

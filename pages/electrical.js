...
const Electrical = () => {
  ...
  useEffect(() => {
    if (router.pathname === "/electrical") {
      setService("Electrical"); // Set default service for Electrical page
    }
  ...
  const services = [
    ...
    "AC Maintenance",
    "AC Duct Cleaning",
    "Electrical", // Adding Electrical to the list of services
    "Plumbing",
    "Sofa Cleaning",
    "Painting",
    "Wallpaper Fixing",
      ...
      <div className="container px-5 py-24 mx-auto flex flex-col lg:flex-row gap-10">
        ...
        >
          ...
          <h1 className="text-gray-900 text-3xl title-font font-medium mb-4">
            Get The Best Electrical Services In Dubai
          </h1>

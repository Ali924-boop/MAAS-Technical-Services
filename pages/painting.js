...
const Painting = () => {
  ...
  useEffect(() => {
    if (router.pathname === "/painting") {
      setService("Painting"); // Set default service for Painting page
    }
  ...
  const services = [
    ...
    "Plumbing",
    "Sofa Cleaning",
    "Painting",  // Painting is active for this page
    "Wallpaper Fixing",
  ];
      ...
      <div className="container px-5 py-24 mx-auto flex flex-col lg:flex-row gap-10">
        ...
        >
          ...
          <h1 className="text-gray-900 text-3xl title-font font-medium mb-4">
            Get The Best Painting Services In Dubai
          </h1>
          <p className="leading-relaxed mb-6">
            Refresh your interiors and exteriors with Maas Technical’s painting services. Our skilled painters prepare surfaces meticulously—repairing cracks, sanding, and priming to ensure flawless adhesion. We use premium, low-VOC paints in your choice of finishes and colors, delivering even coverage and rich, long-lasting hues...
          </p>
